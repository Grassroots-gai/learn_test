    ...
    dir("${WORKSPACE}/tensorflow-intelai-models/benchmarks") {
        withEnv(["summary_log=${summary_log}",
            ...
            sh '''#!/bin/bash
                ...
                echo "-----------------------run inference--------------------------"
                chmod 775 ${WORKSPACE}/validation-tensorflow/quantization/${intel_models_branch}/run_inference_intel-models_tf2.1.sh
                ${WORKSPACE}/validation-tensorflow/quantization/${intel_models_branch}/run_inference_intel-models_tf2.1.sh
            '''
        }
    }
}
