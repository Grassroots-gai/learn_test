...
2. Calls the 'tensorflow/tools/ci_build/linux/mkl/basic-mkl-gpu-test.sh' script

This job accepts params:
- String Type :: CHECKOUT_BRANCH :: A string branch name to clone tensorflow/tensorflow from
*/

static final ArrayList buildLabels = [ 'k80' /*, 'v100'*/ ]
static final String buildScript = 'tensorflow/tools/ci_build/linux/mkl/basic-mkl-gpu-test.sh'
