...
// check default value for DISABLE_MKL 
if (params.DISABLE_MKL) 
    echo "params.DISABLE_MKL is true"
else
    echo "params.DISABLE_MKL is false"
Boolean DISABLE_MKL=params.DISABLE_MKL
