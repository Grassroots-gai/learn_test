...
# ./run.sh --model=resnet50v1_5 --mode=training --precision=fp32 --batch_size=128 --numa_nodes_use=2 --cores_per_instance=28 --cores_per_node=28 --conda_env_name=tensorflow --model_src_dir=`pwd` --data_location /tf_dataset/dataset/TF_Imagenet_FullData
...
function init_params {
    ...
    model_src_dir='/home/limengfx/limengfx/tensorflow/private-tensorflow-benchmarks'
...
function set_environment {
    ...
    # mpi
    export PATH=${HOME}/tools/openmpi-3.0.5/bin/:$PATH
...
function generate_core {
    ...
    do
        ...
        printf " python launch_benchmark.py \
                    ...
                    -a $[ ${real_cores_per_instance} - 1 ] \
                    --checkpoint ./tmp_ckpt \
                    --verbose -- steps=300 train_epochs=1 epochs_between_evals=1 \
