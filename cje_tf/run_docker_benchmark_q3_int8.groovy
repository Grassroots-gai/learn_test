...
NODE_LABEL = 'nervana-clx07.fm.intel.com'
...
// TODO: list the Q3 int8 models here separated by comma
MODEL_LIST="FastRCNN,YoloV2,SSDMobilenet,SSD-VGG16"
...
node( NODE_LABEL ) {
    ...
    try {
        ...
        stage('Checkout') {
            ...
            // SSD-VGG16
            checkout([$class                           : 'GitSCM',
                      branches                         : [[name: 'sfu2/int8']],
                      browser                          : [$class: 'AssemblaWeb', repoUrl: ''],
                      doGenerateSubmoduleConfigurations: false,
                      extensions                       : [[$class           : 'RelativeTargetDirectory',
                                                           relativeTargetDir: 'tensorflow-ssdvgg16']],
                      submoduleCfg                     : [],
                      userRemoteConfigs                : [[credentialsId: "$GIT_CREDENTIAL_LAB",
            ...
            // FastRCNN
            checkout([$class                           : 'GitSCM',
                      branches                         : [[name: 'sriniva2/int8-frcnn']],
                      browser                          : [$class: 'AssemblaWeb', repoUrl: ''],
                      doGenerateSubmoduleConfigurations: false,
                      extensions                       : [[$class           : 'RelativeTargetDirectory',
                                                           relativeTargetDir: 'tensorflow-models-fastrcnn']],
                      submoduleCfg                     : [],
                      userRemoteConfigs                : [[credentialsId: "$GIT_CREDENTIAL_LAB",
                                                           url          : 'https://gitlab.devtools.intel.com/TensorFlow/Shared/tensorflow-models.git']]])
            ...
            checkout([$class                           : 'GitSCM',
                      ...
                      browser                          : [$class: 'AssemblaWeb', repoUrl: ''],
                      doGenerateSubmoduleConfigurations: false,
                      extensions                       : [[$class           : 'RelativeTargetDirectory',                                                           relativeTargetDir: 'tensorflow-YoloV2']],
                      submoduleCfg                     : [],
                      userRemoteConfigs                : [[credentialsId: "$GIT_CREDENTIAL_LAB",
                                                           url          : 'https://gitlab.devtools.intel.com/TensorFlow/Shared/tensorflow-YoloV2.git']]])
        ...
        if (POST_TO_DASHBOARD) {
            ...
            stage('Post to AVUS dashboard') {
                ...
                FRONTEND = 'tensorflow'
                DATATYPE = 'int8'
                POSTING_MODELS = [ "FastRCNN", "InceptionV3", "InceptionResNetV2", "mobilenetv1", "ResNet50", "RFCN", "SSD-VGG16", "SSDMobilenet", "YoloV2" ]
