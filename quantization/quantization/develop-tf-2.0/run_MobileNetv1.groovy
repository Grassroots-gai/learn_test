            ...
            sh '''#!/bin/bash
				...
				then
                    ...
                    python launch_benchmark.py \
                        ...
                        input_layer="input" output_layer="MobilenetV1/Predictions/Reshape_1" > ${benchmark_log_file} 2>&1
                    latency=$(grep "steps = 50" ${benchmark_log_file} | awk -F ' ' '{print $4}' | awk '{printf("%.3f",1000/$1)}')
                    ...
                    python launch_benchmark.py \
                        ...
                        -- input_height=224 input_width=224 warmup_steps=10 steps=50 \
                        input_layer="input" output_layer="MobilenetV1/Predictions/Reshape_1" > ${benchmark_log_file} 2>&1
                    throughput=$(grep "steps = 50" ${benchmark_log_file} | awk -F ' ' '{print $4}' | awk '{printf("%.3f", $1)}')
