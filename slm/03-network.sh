...
if lspci | grep -i omni-path > /dev/null ; then
	...
	yum install -y libibmad libibverbs librdmacm libibcm perftest rdma infinipath-psm expat elfutils-libelf-devel libstdc++-devel gcc-gfortran atlas tcl expect tcsh sysfsutils pciutils opensm-devel opensm-libs bc libhfi1 libhfi1-static libibumad-devel libuuid-devel papi libfabric-devel
	...
	rm -rf /tmp/IntelOPA-Basic.RHEL73-x86_64.10.4.2.0.7
